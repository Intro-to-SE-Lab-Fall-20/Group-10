...
public class ForwardControllerTest extends ApplicationTest {
    ...
    @Test
    public void testForwardInputFields(){
        clickOn("#forwardTo");
        write("nvc29@msstate.edu");
        clickOn("#forwardSubject");
        write("Testing forward input fields");
        verifyThat("#forwardTo", NodeMatchers.isNotNull());
        verifyThat("#forwardSubject", NodeMatchers.isNotNull());
    }
    @Test
